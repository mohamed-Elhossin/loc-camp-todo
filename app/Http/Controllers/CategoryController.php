...
class CategoryController extends Controller
{
     ...
     */
   public function  oneUserCategories(){
    ...
    public function usersCategory()
    {
        ...
        return view('usersCategory', compact('users'));
    }
    public function oneUsersTasks($id)
    {
        // $auth_name = Auth::user()->name;

            $categories = Category::where('for_user', $id)->get();

        $counts = DB::table('caregories_tasks_count')->get();

        return view('oneUserCategories', compact('categories', 'counts'));
    }
